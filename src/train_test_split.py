# it is used to split the dataset into training and testing sets. The training set is used to train the model,
#  while the testing set is used to evaluate its performance. The split can be done randomly or based on a specific time period,
#  depending on the nature of the data and the forecasting task.
