# after the data loading, we can preprocess the data to make it suitable for training and evaluation
#it is used for data cleaning, feature engineering, and data transformation. The preprocessing steps may include handling missing values, encoding categorical variables, 
